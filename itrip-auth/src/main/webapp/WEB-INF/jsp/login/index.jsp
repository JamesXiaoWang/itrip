...
<form action="${pageContext.request.contextPath}/api/dologin"
    ...
    <div>
        ...
        <%--<a href="http://d8b42659.ngrok.io/itrip-auth/api/weCat_login">微信登录</a>--%>
        <a href="${pageContext.request.contextPath}/api/weCat_login">微信登录</a>
        ...
        <a href="${pageContext.request.contextPath}/api/user/register.html">注册</a>
