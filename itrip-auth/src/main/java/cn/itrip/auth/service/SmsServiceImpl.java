...
public class SmsServiceImpl implements SmsService {
	...
	public void send(String to, String templateId, String[] datas) throws Exception {
		...
		//*******************************************************************************
		restAPI.setAccount("8a216da86772f10d016790a251a71739","91ccb1f08d0640cdadb319fba42d19f0");
		...
		//*******************************************************************************
		restAPI.setAppId("8a216da86772f10d016790a251ee173f");
	...
	//*********************************************************************************************************************
	//result = restAPI.sendTemplateSMS("13924236550","1" ,new String[]{"12345","5"});
	result = restAPI.sendTemplateSMS("18973562905","1" ,new String[]{"54321","5"});//免费只能给注册的号码发送
