...
<script type="text/javascript">
    $(function () {
        $("#div_register input[name='userCode']").blur(function () {
            ...
            $.ajax({
                "url": "${pageContext.request.contextPath}/api/user/ckusr_sms",
                "type": "GET",
                "data": {"name": userCode},
                "dataType": "json",
        ...
        $("#btn").click(function () {
            ...
            $.ajax({
                "url": "${pageContext.request.contextPath}/api/user/doregister_sms",
                "type": "POST",
                "data": arrs,
        ...
        $("#activateTijiao").click(function () {
            ...
            alert(code);
            $.ajax({
                "url": "${pageContext.request.contextPath}/api/user/activate_phone",
                "type": "POST",
...
<div id="div_register" align="center">
    <ul class="left-form">
        <h2>山寨注册:</h2>
        <li>
            手机<input type="text" name="userCode"  placeholder="userCode" required/>
